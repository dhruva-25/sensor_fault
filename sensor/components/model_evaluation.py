...
dagshub.init(repo_owner='dhruva-25', repo_name='sensor_fault', mlflow=True)

os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/dhruva-25/sensor_fault.mlflow"
os.environ["MLFLOW_TRACKING_USERNAME"]="dhruva-25"
os.environ["MLFLOW_TRACKING_PASSWORD"]="13f7343da83f5be51d05006c4ca710c7baff6630"
    ...
    def track_mlflow(self,model,classificationmetric):
        ...
        with mlflow.start_run():
            ...
            if tracking_url_type_store != "file":
                ...
                mlflow.sklearn.log_model(model, "model", registered_model_name="BestModel")
            else:
                mlflow.sklearn.log_model(model, "model") 
